...
const API_HOST = 'http://gw.local.test/'  // 更换为你的网站域名, 需要有 https 协议
...
API.getUserInfo = function(e) {
	...
	return new Promise(function(resolve, reject) {
		Auth.getUserInfoByButton(e).then(data=>{
			...
			// #endif
			// #ifdef MP-BAIDU
			var url='/wp-json/mp/v1/baidu/login';
			// #endif
			// #ifdef MP-QQ
			var url='/wp-json/mp/v1/tencent/login';
			// #endif
			// #ifdef MP-TOUTIAO
			var url='/wp-json/mp/v1/toutiao/login';
			// #endif
